...
- (NSObject *)dispatchNdkCall:(NSDictionary *)parameters {
    ...
    void (^callHandler)(NSDictionary *, NSDictionary *)  = [self.callHandlers objectForKey: methodName];
    ...
    if (callHandler) {
        ...
        @catch (NSException* e) {
            void (^exceptionHandler)(NSException *, NSDictionary *, NSDictionary *) =
                    [self.exceptionHandlers objectForKey: NSStringFromClass([e class])];
