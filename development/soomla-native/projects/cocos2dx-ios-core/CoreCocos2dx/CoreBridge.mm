...
+ (void)initGlue {
    ...
    [ndkGlue registerCallHandlerForKey:@"CCNativeRewardStorage::setRewardStatus" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSString *rewardId = parameters[@"reward"];
    ...
    [ndkGlue registerCallHandlerForKey:@"CCNativeRewardStorage::getLastSeqIdxGiven" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSString *rewardId = parameters[@"reward"];
        int res = [RewardStorage getLastSeqIdxGivenForSequenceReward:rewardId];
        retParameters[@"return"] = @(res);
    }];
    [ndkGlue registerCallHandlerForKey:@"CCNativeRewardStorage::setLastSeqIdxGiven" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSString *rewardId = parameters[@"reward"];
        int idx = [parameters[@"idx"] intValue];
        [RewardStorage setLastSeqIdxGiven:idx ForSequenceReward:rewardId];
    }];

    [ndkGlue registerCallHandlerForKey:@"CCNativeKeyValueStorage::getValue" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
    ...
    [ndkGlue registerCallHandlerForKey:@"CCNativeKeyValueStorage::setValue" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSString *key = parameters[@"key"];
        NSString *val = parameters[@"val"];
        [KeyValueStorage setValue:val forKey:key];
    }];
    [ndkGlue registerCallHandlerForKey:@"CCNativeKeyValueStorage::deleteKeyValue" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSString *key = parameters[@"key"];
